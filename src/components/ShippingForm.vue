<template>
  <q-card class="q-pa-md q-ma-md">
    ...
    <q-form @submit.prevent="submit">
      <q-input
        v-model="purchaseForm.firstName"
        label="first name"
        :rules="nameRules"
      />
      <q-input
      ...
      <q-input
        ...
        v-model="purchaseForm.address2"
      />
      <q-select
        label="country"
        required
        v-model="purchaseForm.country"
        :options="countries"
      />
      <q-select
        label="state"
        required
        v-model="purchaseForm.state"
        :options="states"
      >
      </q-select>
...
export default {
  ...
  methods: {
    ...
    submit() {
      const { firstName, lastName, address } = this.purchaseForm
