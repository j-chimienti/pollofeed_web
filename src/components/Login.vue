  ...
  <q-card class="q-px-lg loginCard">
    ...
    <div class="row flex justify-around q-my-lg">
      ...
      <span
        ...
        class="signup-link pointer"
        :class="{
          'text-muted': dispatch === 'login',
          active: dispatch === 'signup',
        }"
        :disabled="dispatch === 'signup'"
        >signup</span
      >
    </div>
    <q-form @submit="login">
      <q-input
        ...
        :rules="[
          (val) =>
            (val && val.includes('@') && val.length > 3) || 'Invalid email',
        ]"
      />
      <q-input
        type="password"
